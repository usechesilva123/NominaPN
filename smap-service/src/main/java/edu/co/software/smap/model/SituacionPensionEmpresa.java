...
@Entity(name = "ESTADO_SALUD_EMPRESA")
public class SituacionPensionEmpresa {
	...
	@ManyToOne
	@JoinColumn(name="descuentoEmpresa", referencedColumnName = "id", nullable = false)
	private DescuentoEmpresa descuento;
	
	@ManyToOne
	@JoinColumn(name="salarioPagar", referencedColumnName = "id", nullable = false)
	private SalarioPago salarioPago;
	
	public SituacionPensionEmpresa() {
		super();
	 ...
	 * @param salarioPago
	 */
	public SituacionPensionEmpresa(int id, String estado, int montoPago, int pagoObligatorio, int diferencia,
			int salario, int tarifa, int iBCEmpleado, Date fechaPago, Empresa empresa, DescuentoEmpresa descuento,
	 ...
	 */
	public DescuentoEmpresa getDescuento() {
		return descuento;
	}
	 ...
	 */
	public void setDescuento(DescuentoEmpresa descuento) {
		this.descuento = descuento;
	}
