...
@Entity(name = "ESTADO_PENSION_EMPLEADO")
public class SituacionPensionEmpleado {
	...
	public SituacionPensionEmpleado() {
		super();
	 ...
	 * @param salarioPago
	 */
	public SituacionPensionEmpleado(int id, String estado, int montoPago, int pagoObligatorio, int diferencia,
