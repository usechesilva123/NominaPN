...
@Entity(name = "ESTADO_ARL_EMPRESA")
public class SituacionARLEmpresa {
	 ...
	 * @param salarioPago
	 */
	public SituacionARLEmpresa(int id, String estado, int montoPago, int pagoObligatorio, int diferencia, int salario,
