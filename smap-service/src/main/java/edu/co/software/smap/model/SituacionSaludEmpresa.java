...
public class SituacionSaludEmpresa {
	 ...
	 * @param salarioPago
	 */
	public SituacionSaludEmpresa(int id, String estado, int montoPago, int pagoObligatorio, int diferencia, int salario,
			int tarifa, int iBCEmpleado, Date fechaPago, Empresa empresa, DescuentoEmpresa descuento,
